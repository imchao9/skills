...
description: |
  Detect website or web-search changes and notify by webhook or email. Use when the user wants to monitor, watch, track, alert, or notify on changes to pages, competitor pricing, jobs, docs, changelogs, status pages, launches, funding, papers, releases, or mentions. Prefer this over repeated one-off scrapes when recurrence or notification is requested.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
---
