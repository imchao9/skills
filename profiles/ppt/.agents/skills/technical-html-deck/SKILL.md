...
x-provenance: local
x-owner: cm
x-source-note: created from local technical presentation workflow
---
...
6. Render and verify.
   ...
   - Capture screenshots at desktop and mobile widths; for serious runs, capture every slide at 1920x1080.
   - Completion: images load, links resolve, text is legible, layouts do not overlap, and the QA report records residual risk.
